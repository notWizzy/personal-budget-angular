...
//   d3ChartCreated: boolean = false;

//   constructor(private http: HttpClient) {}

//   ngOnInit(): void {
//     this.createPieChartNormal();
//   }

//   createPieChartNormal(): void {
...
//     // Set D3JS chart creation flag to true as well to prevent re-creation
//     this.d3ChartCreated = true;
//   }

//   ngAfterViewInit(): void {
//     if (!this.d3ChartCreated) {
//       this.createD3Chart();
//     }
//   }
...
//   createD3Chart(): void {
//     this.http
//       .get<any>('http://localhost:3000/newbudget')
//       .subscribe((data: D3ChartItem[]) => {
//         // Chart Attributes
//         const width = 500;
//         const height = 500;
...
//         const arc = d3
//           .arc<d3.PieArcDatum<D3ChartItem>>()
//           .innerRadius(0)
//           .outerRadius(radius);
